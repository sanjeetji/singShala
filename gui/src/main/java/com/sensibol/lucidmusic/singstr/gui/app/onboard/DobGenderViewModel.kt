...
@HiltViewModel
internal class DobGenderViewModel @Inject constructor(
    ...
    internal fun updateUserDetail(firstName: String, gender: String, dob: String) {
        launchUseCases {
            _updateUser.postValue(updateUserDetailsUseCase(
                firstName,null, null, dob, gender
            ))
        }
    }
}